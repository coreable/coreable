...
//       }`
//     });
//     user1 = res.body.data.register.result.user;
...
//       query:
//       `mutation {
//         joinGroup(userID: ${user1.userID}, inviteCode: "123") {
//           result {
//             user {
//               userID
//             }
...
//       query:
//       `mutation {
//         joinGroup(userID: ${user1.userID}, inviteCode: "abc") {
//           result {
//             user {
//               userID
//             }
...
//       query:
//       `mutation {
//         joinGroup(userID: ${user1.userID}, inviteCode: "1234") {
//           result {
//             user {
//               userID
//             }

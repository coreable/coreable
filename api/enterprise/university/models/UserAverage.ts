...
const sync = (sequelize: Sequelize) => {
  UniversityUserAverage.init({
    ...
    'tableName': 'UNIVERSITY_USER_AVERAGE',
    'sequelize': sequelize
  });

  return UniversityUserAverage;
}

const assosciate = () => {
  UniversityUserAverage.belongsTo(UniversityUser, {
    foreignKey: 'user_id',
    targetKey: '_id',
    as: 'user'
  });

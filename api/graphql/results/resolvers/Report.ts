...
import { CollaborationTraitsResolver } from "./CollaborationTraits";
import { CommunicationTraitsResolver } from "./CommunicationTraits";
import { TrimReviewToCollaborationTraits } from "../logic/TrimReviewToCollaborationTraits";

export const ReportResolver = new GraphQLObjectType({
  name: 'ReportResolver',
  fields: () => {
    return {
      'normal': {
        ...
        async resolve(user, args, context) {
          if (((context.USER?._id !== user.user_id) || (context.USER?._id !== user._id)) && !context.MANAGER) {
            return null;
          }
        ...
        type: new GraphQLObjectType({
          ...
          fields: () => {
            return {
              ...
              'communication': {
                type: new GraphQLObjectType({
                  name: 'ReportReflectionCommunication',
                  fields: () => {
                    return {
                      'traits': {
                        type: new GraphQLObjectType({
                          name: 'ReportReflectionCommunicationTraits',
                          fields: () => {
                            return {
                              'default': {
                                type: CommunicationTraitsResolver,
                              ...
                              'sorted': {
                                type: new GraphQLList(new GraphQLObjectType({
                                  name: 'ReportSortedReflectionCommunicationTraitsArray',
                                  fields: () => {
                                    return {
                                      'field': {
                                        type: GraphQLString,
                      ...
                      'facets': {
                        type: new GraphQLObjectType({
                          name: 'ReportReflectionCommunicationFacets',
                          fields: () => {
                            return {
                              'default': {
                                type: CommunicationTraitsResolver,
                              ...
                              'sorted': {
                                type: new GraphQLList(new GraphQLObjectType({
                                  name: 'ReportSortedReflectionCommunicationFacetsArray',
                                  fields: () => {
                                    return {
                                      'field': {
                                        type: GraphQLString,
              ...
              'collaboration': {
                type: new GraphQLObjectType({
                  name: 'ReportReflectionCollaboration',
                  fields: () => {
                    return {
                      'traits': {
                        type: new GraphQLObjectType({
                          name: 'ReportReflectionCollaborationTraits',
                          fields: () => {
                            return {
                              'default': {
                                type: CollaborationTraitsResolver,
                                resolve(averages, args, context) {
                                  return averages;
                                }
                              },
                              'sorted': {
                                type: new GraphQLList(new GraphQLObjectType({
                                  name: 'ReportSortedReflectionCollaborationTraitsArray',
                                  fields: () => {
                                    return {
                                      'field': {
                                        type: GraphQLString,
                      ...
                      'facets': {
                        type: new GraphQLObjectType({
                          name: 'ReportReflectionCollaborationFacets',
                          fields: () => {
                            return {
                              'default': {
                                type: CollaborationTraitsResolver,
                              ...
                              'sorted': {
                                type: new GraphQLList(new GraphQLObjectType({
                                  name: 'ReportSortedReflectionCollaborationFacetsArray',
                                  fields: () => {
                                    return {
                                      'field': {
                                        type: GraphQLString,
              ...
              'sorted': {
                type: new GraphQLList(new GraphQLObjectType({
                  name: 'ReportSortedReflectionArray',
                  fields: () => {
                    return {
                      'field': {
                        type: GraphQLString,
